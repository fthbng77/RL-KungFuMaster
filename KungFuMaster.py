...
class DQN:
    def __init__(self, env, lr, gamma, epsilon, epsilon_decay):
        ...
        self.num_observation_space = np.prod(self.observation_space.shape)

        self.model = self.initialize_model()

    #burası önemli bir kısım öncelikle katmanların oluşturulması gerekiyor 
    #eğitimin can alıcı noktalarından birtanesi
    ...
    #ajanın rastgele hareketler ile epsilon değerine göre öğrenmesini sağlar.
    ...
    def train(self, num_episodes=2000, can_stop=True):
        for episode in range(num_episodes):
            ...
            if last_rewards_mean > 28000 and can_stop:
